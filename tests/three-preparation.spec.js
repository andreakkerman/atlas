...
test('compact preparation retains full pipeline coverage and final resolution',async({page},info)=>{
 ...
 expect(ready.snapshot.actualEffects).toEqual({gtao:false,bloom:false,volumeSteps:0,volumeResolution:0,fxaa:true,lightingMode:"golden-evening",sunDirection:[-38,28,24],forestFloor:true});
