...
# Atlas Clock Question Audit

Review-only export of authored variants from `LVL-0001` through `LVL-0020` where `visual.type = "clock"`.
...
- Whole-hour questions: 0
- Half-hour questions: 8
- Quarter-hour questions: 8
- Five-minute questions: 16
- Ten-minute questions: 16
- Plain “over” phrasing: 12
- Plain “voor” phrasing: 12
- “voor half” phrasing: 8
- “over half” phrasing: 8

_Phrasing counts are exclusive: plain “over” and “voor” do not include “over half” or “voor half”._

### Counts per displayed hour

| Displayed hour | Count |
|---:|---:|
| 1 | 6 |
| 2 | 4 |
| 3 | 3 |
...
| Whole hour (`:00`) | 0 |
| Half hour (`:30`) | 8 |
| Quarter hour (`:15`, `:45`) | 8 |
| Five-minute phrasing (`:05`, `:25`, `:35`, `:55`) | 16 |
| Ten-minute phrasing (`:10`, `:20`, `:40`, `:50`) | 16 |
| Other | 0 |

### Authored family counts

| Family | Count |
|---|---:|
| `clock_reading_five_minutes` | 32 |
| `clock_reading_half_hour` | 8 |
| `clock_reading_quarter` | 8 |

### Repeated clock times

| Time | Count | Variant IDs |
|---|---:|---|
| 01:55 | 2 | `shipCompass-4b`, `at-clock-4b` |
| 02:40 | 2 | `shipCompass-3a`, `at-clock-3a` |
| 04:20 | 2 | `shipCompass-1b`, `at-clock-1b` |
| 06:05 | 2 | `fr-clock-1b`, `se-clock-4a` |
| 06:25 | 2 | `shipCompass-2a`, `at-clock-2a` |
| 07:50 | 2 | `shipCompass-3b`, `at-clock-3b` |
| 08:10 | 2 | `shipCompass-1a`, `at-clock-1a` |
| 10:35 | 2 | `shipCompass-2b`, `at-clock-2b` |
| 11:05 | 2 | `shipCompass-4a`, `at-clock-4a` |
...
- Challenge ID: `shipCompass`
- Question slot ID: `shipCompass-slot-1`
...
- Level: LVL-0003 — De Vikinghaven
- Challenge ID: `shipCompass`
- Question slot ID: `shipCompass-slot-2`
...
- Level: LVL-0003 — De Vikinghaven
- Challenge ID: `shipCompass`
- Question slot ID: `shipCompass-slot-3`
...
- Level: LVL-0003 — De Vikinghaven
- Challenge ID: `shipCompass`
- Question slot ID: `shipCompass-slot-4`
...
- Challenge ID: `canalClock`
- Question slot ID: `canal-clock-slot-1`
...
- Level: LVL-0013 — Nederland — Het Begin van de Reis
- Challenge ID: `canalClock`
- Question slot ID: `canal-clock-slot-2`
...
- Level: LVL-0013 — Nederland — Het Begin van de Reis
- Challenge ID: `canalClock`
- Question slot ID: `canal-clock-slot-3`
...
- Level: LVL-0013 — Nederland — Het Begin van de Reis
- Challenge ID: `canalClock`
- Question slot ID: `canal-clock-slot-4`
...
- Challenge ID: `clockTower`
- Question slot ID: `clock-tower-slot-1`
...
- Level: LVL-0014 — Engeland — De Oude Klokkenstad
- Challenge ID: `clockTower`
- Question slot ID: `clock-tower-slot-2`
...
- Level: LVL-0014 — Engeland — De Oude Klokkenstad
- Challenge ID: `clockTower`
- Question slot ID: `clock-tower-slot-3`
...
- Level: LVL-0014 — Engeland — De Oude Klokkenstad
- Challenge ID: `clockTower`
- Question slot ID: `clock-tower-slot-4`
...
- Challenge ID: `villageClock`
- Question slot ID: `village-clock-slot-1`
...
- Level: LVL-0015 — Frankrijk — Het Zonnige Dorpsplein
- Challenge ID: `villageClock`
- Question slot ID: `village-clock-slot-2`
...
- Level: LVL-0015 — Frankrijk — Het Zonnige Dorpsplein
- Challenge ID: `villageClock`
- Question slot ID: `village-clock-slot-3`
...
- Level: LVL-0015 — Frankrijk — Het Zonnige Dorpsplein
- Challenge ID: `villageClock`
- Question slot ID: `village-clock-slot-4`
...
- Challenge ID: `clockHouse`
- Question slot ID: `clock-house-slot-1`
...
- Level: LVL-0017 — Oostenrijk — De Alpenpoort
- Challenge ID: `clockHouse`
- Question slot ID: `clock-house-slot-2`
...
- Level: LVL-0017 — Oostenrijk — De Alpenpoort
- Challenge ID: `clockHouse`
- Question slot ID: `clock-house-slot-3`
...
- Level: LVL-0017 — Oostenrijk — De Alpenpoort
- Challenge ID: `clockHouse`
- Question slot ID: `clock-house-slot-4`
...
- Challenge ID: `harborClock`
- Question slot ID: `harbor-clock-slot-1`
...
- Level: LVL-0019 — Zweden — Het Dorp aan het Water
- Challenge ID: `harborClock`
- Question slot ID: `harbor-clock-slot-2`
...
- Level: LVL-0019 — Zweden — Het Dorp aan het Water
- Challenge ID: `harborClock`
- Question slot ID: `harbor-clock-slot-3`
...
- Level: LVL-0019 — Zweden — Het Dorp aan het Water
- Challenge ID: `harborClock`
- Question slot ID: `harbor-clock-slot-4`
