...
> For current rules, use `Docs/VISION.md`, `Docs/archive/architecture/DECISIONS.md`, `Docs/LEVEL_CONTRACT.md`, `Docs/archive/architecture/LEVEL_METADATA.md`, `Docs/archive/architecture/GENERATION_PIPELINE.md`, and `Docs/DEV_TOOLS.md`.
...
* Updated:
  * `docs/VISION.md`
  * `Docs/archive/architecture/DECISIONS.md`
* Added:
  * `docs/LEVEL_CONTRACT.md`
  * `Docs/archive/architecture/GENERATION_PIPELINE.md`
* Added validator:
