...
The user's new reference authorizes simpler, angular nature in the existing Real 3D world. This was initially a shared asset update. It is now exposed as Atlas 3D; see [world-mode separation](../renderer-investigations/3d-world-modes.md). No commit or deployment is included.
