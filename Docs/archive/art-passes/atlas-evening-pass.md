...
- Documentation: this report, measurements/screenshots, `../../renderer-current-spec.md`, `../renderer-investigations/3d-world-modes.md`. Earlier uncommitted foliage/renderer work was preserved.
