...
- This report, `Docs/archive/renderer-investigations/3d-performance-measurements.json`, `Docs/renderer-current-spec.md` and `Docs/archive/renderer-investigations/3d-world-modes.md`: measurements and current specification.
