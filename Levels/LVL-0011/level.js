...
window.SVEN_LEVEL_DEFINITIONS["LVL-0011"] = {
  ...
  "guideLines": {
    ...
    "start": {
      "speaker": "minnie",
      "text": "Dat paarse licht is prachtig en een beetje eng."
    },
    "moving": {
      "speaker": "moose",
      "text": "Voeten op steen. Niet op lava."
    },
    "nether": {
      "speaker": "moose",
      "text": "Hier wint rustig kijken van stoer doen."
    },
    "object": {
      "speaker": "minnie",
  ...
  "sceneEffects": [
    ...
    {
      "id": "magical-glow-01-copy",
      "label": "Crystal 1 copy",
      "presetId": "magical-glow",
      "variantId": "crystal",
      "presetVersion": 1,
      "enabled": true,
    ...
    {
      "id": "sparks-and-embers-04-copy-copy",
      "label": "Rising sparks 4 copy copy",
      "presetId": "sparks-and-embers",
      "variantId": "rising-sparks",
      "presetVersion": 1,
      "enabled": true,
    ...
    {
      "id": "sparks-and-embers-07",
      "label": "Floating embers 7",
      "presetId": "sparks-and-embers",
    ...
    {
      "id": "sparks-and-embers-07-copy",
      "label": "Floating embers 7 copy",
      "presetId": "sparks-and-embers",
      "variantId": "floating-embers",
      "presetVersion": 1,
      "enabled": true,
    ...
    {
      "id": "sparks-and-embers-09",
      "label": "Floating embers 9",
      "presetId": "sparks-and-embers",
      "variantId": "floating-embers",
      "presetVersion": 1,
      "enabled": true,
    ...
    {
      "id": "sparks-and-embers-09-copy",
      "label": "Floating embers 9 copy",
      "presetId": "sparks-and-embers",
      "variantId": "floating-embers",
      "presetVersion": 1,
      "enabled": true,
