...
window.SVEN_LEVEL_DEFINITIONS["LVL-0016"] = {
  ...
  "companion": {
    "name": "Europakaart",
    "portrait": "Levels/LVL-0016/assets/italie.png"
  },
  "challengeCharacter": {
    "id": "atlas-de-reiziger",
    "name": "Atlas de Reiziger",
    "portrait": "Levels/LVL-0016/assets/atlas-de-reiziger.png",
    "role": "reisgids"
  },
  "guides": {
    "minnie": {
  ...
  "world": {
    ...
    "aspectRatio": 3,
    "viewportWidth": 1000,
    "background": "Levels/LVL-0016/assets/italie.png"
  },
  "learningChallenges": [
    {
      "id": "colosseum",
  ...
  "challengeArt": "Levels/LVL-0016/assets/atlas-de-reiziger.png",
  "player": {
  ...
  "intro": [
    "Italië ligt onder een blauwe hemel.",
    "Drie reistekens staan langs de Romeinse route.",
    "De rechterpoort leidt naar de Alpen."
  ],
  ...
  "guideLines": {
    "welcome": {
      "speaker": "minnie",
      "text": "Oude bogen, druiven en ijs. Italië pakt flink uit."
    },
    "moving": {
      "speaker": "moose",
      "text": "De stenen zijn oud maar stevig. Netjes blijven lopen."
    },
    "route": {
      "speaker": "minnie",
      "text": "De route slingert tussen Rome en de wijngaard."
    },
    "allRunes": {
      "speaker": "moose",
    ...
    "reward": {
      "speaker": "minnie",
      "text": "Ciao Italië! Op naar de bergen."
    }
  },
  "levelSemantics": {
  ...
  "companionMoments": [
    {
      ...
      "event": "LEVEL_ENTER",
      "speaker": "minnie",
      "text": "Het Colosseum links en heuvels vooruit. Wat een route."
    },
    {
      "id": "it-colosseum-attention",
    ...
    },
    {
      ...
      "challengeId": "colosseum",
      "speaker": "moose",
      "text": "Het Colosseum staat al eeuwen goed. Vandaag hoeft er niets bij."
    },
    {
      "id": "it-romanFountain-solved",
      "event": "CHALLENGE_SUCCESS",
      "challengeId": "romanFountain",
      "speaker": "moose",
      "text": "De fontein kent zijn patroon al. En ja, het blijft nat."
    },
    {
      "id": "it-gelatoCart-solved",
      "event": "CHALLENGE_SUCCESS",
      "challengeId": "gelatoCart",
      "speaker": "moose",
      "text": "De ijsjes zijn al geteld. Moose noemt dat voorraadbeheer."
    },
    {
      "id": "it-progress",
      "event": "LEVEL_PROGRESS_MILESTONE",
      "speaker": "minnie",
      "text": "De Romeinse route licht op tussen de druiven."
    },
    {
      "id": "it-blocked",
      "event": "EXIT_BLOCKED",
    ...
    },
    {
      ...
      "speaker": "minnie",
      "text": "Ciao Italië! Ik zie de bergen al."
    }
  ],
  "areas": [
    {
  ...
  "hotspots": [
    {
      ...
      "name": "Druivenpers",
      "defaultAction": "look",
      "look": "Een houten pers tussen de druivenranken."
    },
    {
      "id": "romanGate",
      "objectId": "romanGate",
      ...
      "look": "De poort leidt naar Oostenrijk.",
      "activate": "De route naar Oostenrijk opent."
    }
  ],
  "runes": [
    {
      ...
      "shortName": "Arena",
      "defaultAction": "activate",
      "intro": "De oude bogen staan sterk in de zon.",
      "prompt": "Tel de rijen Romeinse bogen.",
      "solved": "Mooi! Het Colosseum onthult een route.",
      "challengeId": "colosseum"
    },
    {
      "id": "romanFountain",
      "objectId": "romanFountain",
      "name": "Romeinse fontein",
      "shortName": "Fontein",
      "defaultAction": "activate",
      "intro": "Helder water stroomt langs de oude stenen.",
      "prompt": "Tel de stralen van de fontein.",
      "solved": "Goed zo! Het water wijst naar de wijngaard.",
      "challengeId": "romanFountain"
    },
    {
      "id": "gelatoCart",
      ...
      "shortName": "Gelato",
      "defaultAction": "activate",
      "intro": "Kleurige ijsjes staan onder het luifeltje.",
      "prompt": "Tel de hoorntjes gelato.",
      "solved": "Sterk! De gelatokar rolt richting Alpen.",
      "challengeId": "gelatoCart"
    }
  ],
  "sceneEffects": [
  ...
  "reward": {
    ...
    "art": "Levels/LVL-0016/assets/italie.png",
    "nextLevelId": "LVL-0017",
    "nextLabel": "Naar Oostenrijk"
  },
  "ambientAnimals": []
};
