...
window.SVEN_LEVEL_DEFINITIONS["LVL-0014"] = {
  ...
  "companion": {
    "name": "Europakaart",
    "portrait": "Levels/LVL-0014/assets/engeland.png"
  },
  "challengeCharacter": {
    "id": "atlas-de-reiziger",
    "name": "Atlas de Reiziger",
    "portrait": "Levels/LVL-0014/assets/atlas-de-reiziger.png",
    "role": "reisgids"
  },
  "guides": {
    "minnie": {
  ...
  "world": {
    ...
    "aspectRatio": 3,
    "viewportWidth": 1000,
    "background": "Levels/LVL-0014/assets/engeland.png"
  },
  "challengeArt": "Levels/LVL-0014/assets/atlas-de-reiziger.png",
  "learningChallenges": [
    {
      "id": "clockTower",
      "anchorId": "clockTower",
  ...
  "guideLines": {
    "welcome": {
      "speaker": "minnie",
      "text": "Alles tikt en glanst hier. Zelfs de brug lijkt oud en wijs."
    },
    "moving": {
      "speaker": "moose",
      "text": "Stevige kade. Goede brug. We kunnen verder."
    },
    "city": {
      "speaker": "minnie",
      "text": "Tussen de torens verstopt de stad haar route."
    },
    "allRunes": {
      "speaker": "moose",
    ...
    "reward": {
      "speaker": "minnie",
      "text": "Volgende halte: zon en bloemen!"
    }
  },
  "levelSemantics": {
  ...
  "companionMoments": [
    ...
    },
    {
      ...
      "challengeId": "clockTower",
      "speaker": "moose",
      "text": "De oude klok loopt al goed. Nog eens rekenen maakt hem niet jonger."
    },
    {
      "id": "uk-telescope-solved",
      "event": "CHALLENGE_SUCCESS",
      "challengeId": "telescope",
      "speaker": "moose",
      "text": "De telescoop staat al scherp. Ik zie vooral dat hij zwaar is."
    },
    {
      "id": "uk-postbox-solved",
      "event": "CHALLENGE_SUCCESS",
      "challengeId": "postbox",
      "speaker": "moose",
      "text": "De post is al gesorteerd. Zelfs de brieven weten waarheen."
    },
    {
      "id": "uk-progress",
      "event": "LEVEL_PROGRESS_MILESTONE",
      "speaker": "minnie",
      "text": "De klokkenstad geeft haar route stukje voor stukje prijs."
    },
    {
      "id": "uk-blocked",
      "event": "EXIT_BLOCKED",
    ...
    },
    {
      ...
      "speaker": "minnie",
      "text": "Tot ziens, klokkenstad. Op naar het zonnige plein!"
    }
  ],
  "areas": [
    {
  ...
  "hotspots": [
    {
      ...
      "name": "Reiskristal",
      "defaultAction": "look",
      "look": "Een helder kristal dat het avondlicht vangt."
    },
    {
      "id": "collegeGate",
      "objectId": "collegeGate",
      "type": "gate",
      "name": "Collegepoort",
      "defaultAction": "activate",
      "look": "De poort leidt verder naar Frankrijk.",
      "activate": "De route naar Frankrijk opent."
    }
  ],
  "runes": [
    {
      "id": "clockTower",
      "objectId": "clockTower",
      "name": "Oude klokkentoren",
      "shortName": "Klok",
      "defaultAction": "activate",
      "intro": "De klok tikt boven de stenen poort.",
      "prompt": "Tel de slagen van de klok.",
      "solved": "Mooi! De torenklok loopt weer gelijk.",
      "challengeId": "clockTower"
    },
    {
      "id": "telescope",
      "objectId": "telescope",
      "name": "Koperen telescoop",
      "shortName": "Kijker",
      "defaultAction": "activate",
      "intro": "De telescoop wijst over de brug.",
      "prompt": "Tel de verre torens.",
      "solved": "Goed zo! De telescoop vindt Frankrijk.",
      "challengeId": "telescope"
    },
    {
      "id": "postbox",
      "objectId": "postbox",
      "name": "Rode brievenbus",
      "shortName": "Post",
      "defaultAction": "activate",
      "intro": "De rode brievenbus rammelt zacht.",
      "prompt": "Tel de reisbrieven.",
      "solved": "Sterk! De brievenbus geeft de route door.",
      "challengeId": "postbox"
    }
  ],
  "sceneEffects": [
  ...
  "reward": {
    ...
    "art": "Levels/LVL-0014/assets/engeland.png",
