...
window.SVEN_LEVEL_DEFINITIONS["LVL-0007"] = {
  ...
  "guideLines": {
    ...
    "start": {
      "speaker": "minnie",
      "text": "Daar is een sloep. En een weg naar buiten."
    },
    "moving": {
      "speaker": "moose",
      "text": "Let op de natte stenen. Het licht is dichtbij."
    },
    "grotto": {
      "speaker": "moose",
      "text": "Water links, rotsen rechts. Kies rustig je route."
    },
    "object": {
      "speaker": "minnie",
      "text": "Ik voel zonlicht. Dit hoort bij de uitgang."
    },
    "allRunes": {
      "speaker": "moose",
  ...
  sceneEffects: [
        ...
        {
              id: "sun-presence-01-copy",
              label: "Warm day sun 1 copy",
              presetId: "sun-presence",
              variantId: "warm-day-sun",
              presetVersion: 1,
              enabled: true,
