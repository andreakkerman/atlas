...
window.SVEN_LEVEL_DEFINITIONS["LVL-0020"] = {
  ...
  "companion": {
    "name": "Europakaart",
    "portrait": "Levels/LVL-0020/assets/rheden.png"
  },
  "challengeCharacter": {
    "id": "atlas-de-reiziger",
    "name": "Atlas de Reiziger",
    "portrait": "Levels/LVL-0020/assets/atlas-de-reiziger.png",
    "role": "reisgids"
  },
  "guides": {
    "minnie": {
  ...
  "world": {
    ...
    "aspectRatio": 3,
    "viewportWidth": 1000,
    "background": "Levels/LVL-0020/assets/rheden.png"
  },
  "learningChallenges": [
    {
      "id": "mapBoard",
  ...
  "challengeArt": "Levels/LVL-0020/assets/atlas-de-reiziger.png",
  "player": {
  ...
  "intro": [
    "Sven is terug op de Posbank.",
    "Drie thuiskomsttekens bewaren de herinneringen.",
    "Het bospad rondt de grote reis af."
  ],
  ...
  "guideLines": {
    "welcome": {
      "speaker": "minnie",
      "text": "De paarse heide! We zijn echt weer thuis."
    },
    "moving": {
      "speaker": "moose",
      "text": "Bekende grond. Mijn poten herkennen het pad."
    },
    "heath": {
      "speaker": "minnie",
      "text": "De Posbank bewaart het laatste stukje van onze reis."
    },
    "allRunes": {
      "speaker": "moose",
    ...
    "reward": {
      "speaker": "minnie",
      "text": "Europa rond en weer thuis. Wat een reis!"
    }
  },
  "levelSemantics": {
  ...
  "companionMoments": [
    {
      ...
      "event": "LEVEL_ENTER",
      "speaker": "minnie",
      "text": "Paarse heide en bekende bomen. We zijn weer op de Posbank!"
    },
    {
      "id": "rh-mapBoard-attention",
    ...
    },
    {
      ...
      "challengeId": "mapBoard",
      "speaker": "moose",
      "text": "De Posbankkaart klopt al. Verdwalen zou nu echt extra werk zijn."
    },
    {
      "id": "rh-telescope-solved",
      "event": "CHALLENGE_SUCCESS",
      "challengeId": "telescope",
      "speaker": "moose",
      "text": "De kijker staat al scherp. Ik zie vooral heel veel heide."
    },
    {
      "id": "rh-deerStatue-solved",
      "event": "CHALLENGE_SUCCESS",
      "challengeId": "deerStatue",
      "speaker": "moose",
      "text": "Het hert heeft ons al gezien. Nog eens rekenen maakt het niet minder houten."
    },
    {
      "id": "rh-progress",
      "event": "LEVEL_PROGRESS_MILESTONE",
      "speaker": "minnie",
      "text": "Onze hele reis verschijnt tussen de heidevelden."
    },
    {
      "id": "rh-blocked",
      "event": "EXIT_BLOCKED",
    ...
    },
    {
      ...
      "speaker": "minnie",
      "text": "Van Nederland door Europa en terug naar Rheden. We hebben het gedaan!"
    }
  ],
  "areas": [
    {
  ...
  "hotspots": [
    {
      ...
      "objectId": "forestGate",
      "type": "gate",
      "name": "Bospad naar huis",
      "defaultAction": "activate",
      "look": "Dit vertrouwde pad rondt de reis af.",
      "activate": "Sven loopt tevreden naar huis."
    }
  ],
  "runes": [
    {
      ...
      "shortName": "Kaart",
      "defaultAction": "activate",
      "intro": "De kaart toont paden door bos en heide.",
      "prompt": "Tel de vakken op de kaart.",
      "solved": "Mooi! De kaart herkent de hele reis.",
      "challengeId": "mapBoard"
    },
    {
      "id": "telescope",
      ...
      "shortName": "Kijker",
      "defaultAction": "activate",
      "intro": "De kijker staat gericht op de paarse heide.",
      "prompt": "Tel de verre heidevelden.",
      "solved": "Goed zo! De kijker vindt het eindpunt.",
      "challengeId": "telescope"
    },
    {
      "id": "deerStatue",
      ...
      "shortName": "Hert",
      "defaultAction": "activate",
      "intro": "Het houten hert kijkt over de Posbank.",
      "prompt": "Tel de punten van het gewei.",
      "solved": "Sterk! Het hert verwelkomt Sven thuis.",
      "challengeId": "deerStatue"
    }
  ],
  "reward": {
    ...
    "art": "Levels/LVL-0020/assets/rheden.png"
  }
};
